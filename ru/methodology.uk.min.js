...
(function (global) {
    var __i18n__ = ((function () {
            ...
            return i18n;
        })()).decl({"header":{"forum":"Форум"},"article-amendments":{"text":"Якщо ви помітили помилку, або хочете доповнити статтю, ви завжди можете або написати нам про це на ","issue":"Гітхабі","edit":", або поправити статтю з допомогою "},"social-likes":{"text":"Поділитися зі світом"}}),
        defineAsGlobal = true;
