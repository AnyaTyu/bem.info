...
(function (global) {
    var __i18n__ = ((function () {
            ...
            return i18n;
        })()).decl({"header":{"forum":"Форум"},"article-amendments":{"text":"Если вы заметили ошибку или хотите чем-то дополнить статью, вы всегда можете или написать нам об этом на ","issue":"Гитхабе","edit":", или поправить статью с помощью "},"social-likes":{"text":"Поделиться c миром"}}),
        defineAsGlobal = true;
...
/* begin: ../../blocks/common/header/header.js */
...
/* end: ../../blocks/common/header/header.js */
